"""
Configuration file for the food weight prediction pipeline.
"""
import os
...
# Project paths
# source/config/config.py -> source/config -> source -> root
PROJECT_ROOT = Path(__file__).parent.parent.parent
DATA_DIR = PROJECT_ROOT / "source" / "data"
...
# Classification parameters (EfficientNet & others)
...
OPTUNA_N_TRIALS = 20
OPTUNA_STORAGE = f"sqlite:///{(OUTPUTS_DIR / 'optuna.db')}"
